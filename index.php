...
<body>
    ...
    <header>
        <h1 style='color: #ed6337' class="text-center">Apartamentos</h1>
    ...
    <div class="container my-3" id="apartments-container"></div>
    ...
    <script>
        ...
        const gotToAddEditApartmentPage = (apartment) => {
            ...
            window.location.href = 'addEditApartment.php'; // Navigate to add/edit department
        }
